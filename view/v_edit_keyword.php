						...
						<div>
							<div>
								...
								<form type="multipart/form-data" method="POST">
									<h3>Keyword1</h3>
									<input class="form-control" type="text" value="<?php echo $keyword1 ?>" name="name1">
									<h3>Keyword2</h3>
									<input class="form-control" type="text" value="<?php echo $keyword2 ?>" name="name2">
									<h3>Distance</h3>
									<input class="form-control" type="text" value="<?php echo $distance ?>" name="distance">
									<br><br>
